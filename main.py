...
DAILY_REWARDS = {
    "Domoball": 6,
    # 1% chance d'obtenir une PerfectDomoball (très rare !)
...
async def capture(ctx):
    ...
    if has_perfect:
        ...
        player["xp"] += 2
        save_players(players)
        msg = f"💎 {ctx.author.mention} used a **PerfectDomoball** and INSTANTLY captured **{spawned_domon['name']}**! +2 XP!"
